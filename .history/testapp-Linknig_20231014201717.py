...
####### Connecting Signals of UI elements
        ...
        self.updateAction.triggered.connect(signal_viewer_1.update_new)
...
####### Method to setup the UI
    ...
    # SETTING UP THE UI
        ...
        self.grpbx_signal_viewers.addWidget(signal_viewer_1)
        self.grpbx_signal_viewers.addWidget(signal_viewer_2)
