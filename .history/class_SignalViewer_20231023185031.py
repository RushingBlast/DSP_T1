...
# Link View to another view
    def link_view_to(self, target_widget):
        ...
        if self.is_linked:
            ...
            self.view_widget.getPlotItem().setXLink()
            self.view_widget.getPlotItem().setYLink()
...
# Update plot widget
    def update(self):
        if self.loaded_signals:
            ...
            self.horizontalScrollBar.setMaximum(self.x_max)
            self.horizontalScrollBar.setValue(self.current_index)
