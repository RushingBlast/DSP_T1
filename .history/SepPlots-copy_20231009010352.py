...
def create_plot():
    ...
    plot_item1.setFlag(Qt.ItemFlag.ItemIsSelectable)
    plot_item1.setFlag(Qt.ItemFlag.ItemIsEditable)
    plot_item2.setFlag(Qt.ItemFlag.ItemIsSelectable)
    plot_item2.setFlag(Qt.ItemFlag.ItemIsEditable)
