...
####### Method to setup the UI
    ...
    # SETTING UP THE UI
        ...
        signal_viewer_2 = SignalView(QtCore.Qt.Key.Key_Space, QtCore.Qt.Key.Key_Left,QtCore.Qt.Key.Key_Right,QtCore.Qt.Key.Key_Control + QtCore.Qt.Key.Key_O,QtCore.Qt.Key.Key_Control + QtCore.Qt.Key.Key_Up,QtCore.Qt.Key.Key_Control + QtCore.Qt.Key.Key_Down)
