...
class appwindow(QMainWindow):
    ...
    def initUI(self):
        ...
        signal_viewer_1.graphicsView.sigXRangeChanged.connect(self.update_plot1_range)
        signal_viewer_2.graphicsView.sigXRangeChanged.connect(self.update_plot2_range)
        signal_viewer_1.graphicsView.sigYRangeChanged.connect(self.update_plot1_range)
        signal_viewer_2.graphicsView.sigYRangeChanged.connect(self.update_plot2_range)
    ...
    def update_plot1_y_range(self):
        signal_viewer_2.graphicsView.setYRange(*signal_viewer_1.graphicsView.viewRange()[0], padding = 0)
    
    def update_plot2_y_range(self):
        signal_viewer_1.graphicsView.setYRange(*signal_viewer_2.graphicsView.viewRange()[0], padding = 0)
