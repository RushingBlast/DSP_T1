...
################################################      CLASS VARIABLES      ################################################
        ...
        self.signal_edit_buttons_enabled = False # Flag to ease toggilng of signal selection-dependent buttons
...
# Function to enable/disable buttons that need a signal to be selected
    def toggle_signal_buttons(self):
        self.signal_edit_buttons_enabled = not self.signal_edit_buttons_enabled
        self.btn_change_color.setEnabled(self.signal_edit_buttons_enabled)
        self.btn_transfer.setEnabled(self.signal_edit_buttons_enabled)
        self.btn_remove.setEnabled(self.signal_edit_buttons_enabled)
