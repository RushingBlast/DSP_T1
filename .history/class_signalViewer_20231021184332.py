...
class dialogRename(QDialog):
    def __init__(self, parent = None):
        super(dialogRename, self).__init__()
        self.setWindowTitle("Enter new signal name")
        self.setFixedSize(350, 100)
        self.dialog_buttons = QtWidgets.QDialogButtonBox.Ok | QtWidgets.QDialogButtonBox.Cancel
        
        self.buttonBox = QtWidgets.QDialogButtonBox(self.dialog_buttons)
        self.buttonBox.accepted.connect(self.return_new_name)
        self.buttonBox.rejected.connect(self.reject)
        self.layout = QtWidgets.QVBoxLayout()
        
        self.lineEdit_rename = QtWidgets.QLineEdit(self) # Takes input from user
        self.layout.addWidget(self.lineEdit_rename)
...
################################################      CLASS VARIABLES      ################################################
        ...
        self.colors_list = self.colors_list = [
                                                ...
                                                "cyan", "orange", "purple",
                                                "brown", "pink", "gold", "lime", "teal",
                                                "navy", "olive", "maroon", "indigo", "salmon"
...
#TODO - Failed implementation of a custom context menu. Fix or remove
# Hande Context Menu
...
# Rename selected signal
    def rename_selected_signal(self):
        new_name, accept = QtWidgets.QInputDialog.getText(self, "Enter new signal name", "Signal name: ")
...
# Return Clicked signal
    def return_clicked_signal(self):
        ...
        self.selected_signal = self.loaded_signals[self.index_of_selected_signal]
...
# Add signals
    def add_signal(self):
        ...
        signal = pg.PlotDataItem(data, pen = curve_color, name = "Signal_"+ str(len(self.loaded_signals)) ,clickable=True)
...
# Starts signal playback
    def start_animation(self):
        ...
        vb = self.view_widget.getPlotItem().getViewBox()
        vb.setAutoVisible(y = 1.0)
        min_x, max_x, _, _ = self.find_data_range()
