...
################################################      CLASS VARIABLES      ################################################
        ...
        self.colors_list = self.colors_list = [
                                                ...
                                                "cyan", "orange", "purple", "pink", "lime", "teal",
                                                "navy", "maroon", "indigo", "salmon"
...
# Saving screenshot as pdf
    def save_screenshots_as_pdf(self):
        ...
        try:
            ...
            for signal in self.loaded_signals:
                # table_data.extend[[signal.opts['name'], signal.stats[0], signal.stats[2], 'NAN', signal.stats[3], signal.stats[4]]]
                table_data.extend[[signal.opts['name'], 'idk', 'idk', 'NAN', 'idk', 'idk']]
                # print(signal.opts['name'], signal.stats[1])
