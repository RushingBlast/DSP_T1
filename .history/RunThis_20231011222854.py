...
# PLAY_PAUSE_KEY
        self.v1_btn_start_pause.clicked.connect(self.buttonRename(self.v2_btn_start_pause))
...
# Start signal playback
    def start_animation(self, viewButton):
        self.timer.start(1)
        self.animation_running = True
        QtWidgets.QPushButton.setChecked(viewButton, False)
        QtWidgets.QPushButton.setText(viewButton, 'Stop Animation')
...
# Test Function. Ignore
    def buttonRename(self, targetButton):
        QtWidgets.QPushButton.setText(targetButton, 'IT WORKS')
