...
# Saving screenshot as pdf
    def save_screenshots_as_pdf(self):
        ...
        try:
            ...
            for signal in self.loaded_signals:
                table_data.extend([[signal.opts['name'], round(signal.stats[0], 2), round(signal.stats[2], 2), f"{len(signal.getData[1])} ms", round(signal.stats[3], 2), round(signal.stats[4], 2)]])
