...
class main_window(QMainWindow):
    ...
    def init_ui(self):
        ...
        signal_view_1.btn_link.clicked.connect(signal_view_1.view_widget.link_view_to(signal_view_2))
        signal_view_2.btn_link.clicked.connect(signal_view_1.view_widget.link_view_to(signal_view_2))
