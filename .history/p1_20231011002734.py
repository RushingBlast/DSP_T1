...
from PyQt6.QtWidgets import QApplication, QMainWindow, QFileDialog, QWidget, QGraphicsView, QDialog, QGridLayout
import numpy as np
        ...
        if file_path:
            ...
            # Handling import of EDF file
                ...
                try:
                    ...
                    edf_DataFrame = pd.DataFrame(signal_data).T
            ...
            # Handling import of DAT file
                ...
                try:
                    ...
                    with open(file_path, 'rb') as dat_file: # 'rb' is just an argument to open file in 'Read in Binary' mode
                        ...
                        dat_DataFrame = pd.DataFrame(dat_data)
