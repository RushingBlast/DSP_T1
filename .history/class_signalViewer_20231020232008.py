...
# Mouse click modifier
    def mousePressEvent(self,event, QtWidgets.QObject object):
        if event.button() == QtCore.Qt.RightButton:
            print(f"Right button clicked on {event.}")
        super().mousePressEvent(event)

# Handles right clicking
    def handle_right_click(self, plotdataitem):
        print(f"right clicked signal {plotdataitem.name}")
