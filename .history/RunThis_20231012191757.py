...
# Optimized version of Update_v1 
    def update_v1(self):
        ...
        if self.loaded_signals and self.current_index < loaded_signals_length:
            for loaded_signal, y_values, x_values in zip(self.loaded_signals, self.v1_y_values, self.v1_x_values): #type: ignore
...
# Update View 2
    def update_v2(self):
        loaded_signals_length = len(self.loaded_signals[0])
        if self.loaded_signals and self.current_index < loaded_signals_length:
            for loaded_signal, y_values, x_values in zip(self.loaded_signals, self.v2_y_values, self.v2_x_values): #type: ignore
                y_values.append(loaded_signal[self.current_index])
                x_values.append(self.current_index)
