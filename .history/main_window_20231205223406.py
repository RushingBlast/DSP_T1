...
class main_window(QMainWindow):
    ...
    def toggle_linking(self):
        ...
        # Control view 2 with view 1's buttons
            ...
            self.signal_view_1.btn_play_pause.clicked.connect(self.signal_view_2.toggle_animation)
            ...
            self.signal_view_1.btn_play_pause.clicked.disconnect(self.signal_view_2.toggle_animation)
