...
class myWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.timer.timeout.connect(self.update_v1)
...
# PLAY_PAUSE_KEY
        self.v1_btn_start_pause.clicked.connect(self.start_animation)
...
# Start signal playback
    def start_animation(self):
        ...
        senderBtn.setChecked(senderBtn, False)
        senderBtn.setText(senderBtn, 'Stop Animation')
...
# Stop Signal Playback
    def stop_animation(self):
        ...
        senderBtn.setChecked(viewButton,True)
        senderBtn.setText(viewButton,'Play Animation')
