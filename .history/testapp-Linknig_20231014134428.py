...
####### Method to setup the UI
    ...
    # SETTING UP THE UI
        ...
        # plot_item1 = signal_viewer_1.plot_widget.plot(x, y, pen='r')
        # plot_item2 = signal_viewer_2.plot_widget.plot(x, y, pen='b')
    ...
    def toggle_linking(self):
        ...
        if self.linking_enabled:
            ...
            signal_viewer_1.btn_play_pause.clicked.connect(lambda: signal_viewer_1.toggle_animation(), signal_viewer_2.toggle_animation())
        else:
            self.linkAction.setText("Link")
            signal_viewer_1.btn_play_pause.clicked.connect(signal_viewer_1.toggle_animation)
