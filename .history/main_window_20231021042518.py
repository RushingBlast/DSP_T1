...
class main_window(QMainWindow):
    ...
    def init_ui(self):
        ...
        signal_view_1.btn_link.clicked.connect(lambda: signal_view_1.link_view_to(signal_view_2.view_widget))
        signal_view_2.btn_link.clicked.connect(lambda: signal_view_1.link_view_to(signal_view_2.view_widget))
