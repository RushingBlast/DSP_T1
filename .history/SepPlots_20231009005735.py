...
def create_plot():
    ...
    plot_item1.setFlag(Qt.ItemIsMovable)
    plot_item1.setFlag(Qt.ItemIsSelectable)
    plot_item2.setFlag(Qt.ItemIsMovable)
    plot_item2.setFlag(Qt.ItemIsSelectable)
...
def main():
    ...
    button = QPushButton("KILL ME")

    layout.addWidget(button)

    button.clicked.connect(addplotwidget())
    # plot = pg.PlotWidget()
