...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.v1_btn_save.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Assets/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_save.setIcon(icon1)
        ...
        self.v1_btn_restart.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Assets/restart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_restart.setIcon(icon2)
        ...
        self.v1_btn_zoom_in.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Assets/zoom_in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_zoom_in.setIcon(icon3)
        ...
        self.v1_btn_move_left.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Assets/left_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_move_left.setIcon(icon4)
        ...
        self.v1_btn_zoom_out.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Assets/zoom_out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_zoom_out.setIcon(icon5)
        ...
        self.v1_btn_move_right.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("Assets/right_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.v1_btn_move_right.setIcon(icon6)
        ...
        self.v2_btn_start_pause.setText("")
        self.v2_btn_start_pause.setIcon(icon)
        ...
        self.v2_btn_restart.setText("")
        self.v2_btn_restart.setIcon(icon2)
        ...
        self.v2_btn_move_left.setText("")
        self.v2_btn_move_left.setIcon(icon4)
        ...
        self.v2_btn_move_right.setText("")
        self.v2_btn_move_right.setIcon(icon6)
        ...
        self.v2_btn_save.setText("")
        self.v2_btn_save.setIcon(icon1)
        ...
        self.v2_btn_zoom_in.setText("")
        self.v2_btn_zoom_in.setIcon(icon3)
        ...
        self.v2_btn_zoom_out.setText("")
        self.v2_btn_zoom_out.setIcon(icon5)
